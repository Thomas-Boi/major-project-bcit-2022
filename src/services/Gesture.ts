...
/**
 * Back gesture for moving between scenes.
 */
export const GRAB_THUMBS_OUT = new Gesture("GRAB THUMBS OUT", OUTWARD_THUMB, GRAB_CLOSED_FINGER, GRAB_CLOSED_FINGER, GRAB_CLOSED_FINGER, GRAB_CLOSED_PINKY)